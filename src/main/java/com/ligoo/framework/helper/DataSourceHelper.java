...
public final class DataSourceHelper {
    ...
    /**
     * description: 查询并返回单个列值
     * author: Administrator
     * date: 2018/12/24 13:39
     *
     * @param:
     * @return:
     */
    ...
    public static Object[] queryArray(String sql, Object... params){
        ...
        try {
            Connection conn = getConnection();
            array = QUERY_RUNNER.query(conn, sql, new ArrayHandler(), params);
        } catch (SQLException e) {
    ...
    public static Map<String,Object> queryMap(String sql, Object... params){
        ...
        try {
            Connection conn = getConnection();
            map = QUERY_RUNNER.query(conn, sql, new MapHandler(), params);
        } catch (SQLException e) {
